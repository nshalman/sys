...
func getpeerucred(fd uintptr, ucred *unsafe.Pointer) (err error) {
...
func ucred_geteuid(ucred unsafe.Pointer) (uid Uid_t) {
...
func ucred_getegid(ucred unsafe.Pointer) (gid Gid_t) {
...
func ucred_getpid(ucred unsafe.Pointer) (pid Pid_t) {
...
func ucred_free(ucred unsafe.Pointer) {
